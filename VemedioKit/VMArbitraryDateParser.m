...
@interface VMArbitraryDateParser ()
@property (strong) NSDictionary* timezoneValues;
@property (strong) NSCharacterSet* timeValueCharacterSet;
@property (strong) NSCharacterSet* europeanDateValueCharacterSet;
@property (strong) NSCharacterSet* americanDateValueCharacterSet;
@property (strong) NSCharacterSet* dotDateValueCharacterSet;
@property (strong) NSCharacterSet* iso8601CharacterSet;
@property (strong) NSCharacterSet* iso8601TimeAndTimezoneValueCharacterSet;
@property (strong) NSArray* postMeridiemTokens;
@property (strong) NSDictionary* monthTokens;
@property (strong) NSArray* dayTokens;
@property (strong) NSCharacterSet* decimalCharacterSet;
@property (strong) NSCalendar* calendar;
@end

@implementation VMArbitraryDateParser
